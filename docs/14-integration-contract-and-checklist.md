...
- [ ] **Money:** Will prices be transmitted as decimals/floats (`500.50`) or integers in cents (`50050`)? _Decision: Use Decimals/Floats for this MVP to keep frontend logic simple, but beware of JS rounding errors._
