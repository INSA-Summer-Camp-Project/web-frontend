...
- **Workers (Individual) & Businesses:** Professionals offering services. _(Note: For the MVP, Individuals and Businesses should be treated as the exact same technical entity to save time, simply distinguished by a profile flag)._
