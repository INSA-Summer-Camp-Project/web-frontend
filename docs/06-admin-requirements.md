...
- **User Moderation:** Admins can view all registered users and manage them (FR-051). _Assumption:_ This includes soft-deleting or suspending accounts that violate terms.
