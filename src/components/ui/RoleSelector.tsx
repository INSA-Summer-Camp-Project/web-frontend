  ...
  if (variant === "segmented") {
    return (
      <div className={`flex flex-col gap-1.5 w-full ${className}`}>
        <div className="inline-flex w-full p-1 bg-surface-alt rounded-lg border border-outline-variant">
          {options.map((option) => {
            ...
            return (
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-3 text-xs md:text-sm font-semibold rounded-md transition-all duration-200 ${
                  isSelected
                    ? "bg-primary text-on-primary shadow-sm"
                    : "text-ink-muted hover:text-ink hover:bg-surface-dim/50"
        ...
        {options.map((option) => {
          ...
          return (
            ...
            >
              ...
              />
              <div
                className={`h-full rounded-lg border-2 p-3.5 flex flex-col items-center text-center transition-all duration-200 shadow-sm ${
                  isSelected
                    ? "border-primary bg-primary-tint"
                    : "border-outline-variant bg-surface-alt hover:border-border-strong hover:bg-surface-dim"
                }`}
              >
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 shadow-sm transition-transform group-hover:scale-105 border border-outline-variant ${
                    isSelected
