...
export default function CheckoutPage() {
  ...
  const { mutate: initializeCheckout, isPending: isCheckingOut } =
    useCheckout();
  ...
  const basePrice =
    typeof acceptedApp.proposedPrice === "string"
      ? parseFloat(acceptedApp.proposedPrice)
      : acceptedApp.proposedPrice || 0;
        ...
        <div className="flex-1 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="font-semibold text-ink">
                  {acceptedApp.worker?.user?.name || "Worker"}
                </p>
              </div>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-md p-6">
            ...
            <p className="text-sm text-ink-secondary">
              Your payment will be processed securely via Chapa to finalize the
              job and lock in the agreed price.
            </p>
          </div>
        </div>
